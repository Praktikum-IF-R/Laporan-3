...
//overloading method yang digunakan untuk mengubah huruf menjadi angka    
    public static String overloadingMeth(String huruf) {
        ...
        if (huruf.equalsIgnoreCase("nol")) {
            ...
            //fungsi split digunakan untuk memberi jarak pada hurug
